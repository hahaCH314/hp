...
- 購入ボタン（¥500）は Ko-fi の **Shop タブ** `https://ko-fi.com/ihafam/shop` に繋いである。商品を作ったら商品ページ（`ko-fi.com/s/xxxxxxxx`）の直リンクに差し替える。**トップページ（`/ihafam`）に向けてはいけない** — あそこは寄付の画面で、寄付は CMCUBE ではなく製品 CUBICENGINE のもの。同じ Ko-fi アカウントに寄付と販売が同居している
